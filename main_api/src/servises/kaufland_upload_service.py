...
class KauflandUploadService:
    def __init__(self, controller):
        self.controller: KauflandController = controller  # Kaufland Controller из каталога controller
    ...
    async def upload_collection(self, raw_items: list[dict], job_id: str | None = None) -> bool:
